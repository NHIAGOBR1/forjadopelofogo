    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-deepBlack pt-20 md:pt-0">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 text-center md:text-left order-2 md:order-1">
          {/* REMOVIDO: Animação de opacidade inicial para melhorar LCP. O texto aparece imediatamente. */}
        ...
        >
          ...
          {/* OTIMIZAÇÃO: 
              1. Removida animação de escala inicial para evitar atraso de pintura (LCP).
              2. Adicionado fetchPriority="high".
              3. Adicionado width/height explícitos para evitar Layout Shift (CLS).
          */}
          <img 
            src={BOOK_COVER}
